...
int hand__num = 0;
int cou = 0;
int ca_r = 0; // 0=(停止), 1=ca(拾う), 2=re(出す)
...
void ang_serial() {
  ...
  Serial.print("stop_mo_eme_switch: ");
  Serial.println(stop_mo_eme_switch);
